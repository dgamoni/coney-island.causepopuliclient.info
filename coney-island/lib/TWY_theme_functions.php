...
function TWY_theme_option_menu(){
	$TWY_theme_option_name = "Coney Island";
	$TWY_theme_page1="General Options";
	$TWY_theme_page1_file="controlpanel.php";
	
	add_menu_page($TWY_theme_option_name, $TWY_theme_option_name, 7,$TWY_theme_page1_file, 'TWYgeneral');
  	add_submenu_page($TWY_theme_page1_file, $TWY_theme_page1, $TWY_theme_page1, 7, $TWY_theme_page1_file, 'TWYgeneral');
}
...
<table width="100%">
    ...
    <td style="-moz-border-radius: 6px;-khtml-border-radius: 6px;-webkit-border-radius: 6px;border-radius: 6px;border:1px solid #FFFFFF;padding:3px;background:#F4F4F4;font-size:11px;">
		<h2 style="color:#BA3F42;font-size:19px;margin-left:10px;font-weight:normal;"><i>Welcome to Coney Island-Theme Settings</i></h2>
    </td>
</tr> 
</table>
<?php
