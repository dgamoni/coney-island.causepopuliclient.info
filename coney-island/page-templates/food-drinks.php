...
<?php 
$wp_cat =  $wp_query->query('post_type=food-drinks&showposts=100&order=DESC&paged='.$paged.'');
...
<?php endwhile;  ?>
<?php echo do_shortcode('[ajax_load_more post_type="post, max_pages="100" food-drinks"]'); ?>
</div>
