...
<?php 
$wp_cat =  $wp_query->query('post_type=retail-shops&showposts=100&order=DESC&paged='.$paged.'');
...
<?php endwhile;  ?>
<?php echo do_shortcode('[ajax_load_more post_type="post, retail-shops" max_pages="100"]'); ?>
