...
function twentyfourteen_setup() {
	...
	register_nav_menus( array(
		...
		'about' => __( 'About Us Right sidebar', 'twentyfourteen' ),
		'policy-advocacy' => __( 'Policy Advocacy Right sidebar', 'twentyfourteen' ),
	) );
...
function twentyfourteen_widgets_init() {
	...
	register_sidebar( array(
		'name'          => __( 'Weather', 'twentyfourteen' ),
		'id'            => 'Weather',
	...
	register_sidebar( array(
		'name'          => __( 'Coney News', 'twentyfourteen' ),
		'id'            => 'coney-news',
		'description'   => __( 'Main sidebar that appears on the left.', 'twentyfourteen' ),
		'before_widget' => '<aside id="%1$s" class="widget %2$s">',
		'after_widget'  => '</aside>',
	...
	register_sidebar( array(
		'name'          => __( 'Picture of Week', 'twentyfourteen' ),
		'id'            => 'picture-week',
		'description'   => __( 'Main sidebar that appears on the left.', 'twentyfourteen' ),
		'before_widget' => '<aside id="%1$s" class="widget %2$s">',
		'after_widget'  => '</aside>',
	...
	register_sidebar( array(
		'name'          => __( 'Upcoming Events', 'twentyfourteen' ),
		'id'            => 'events',
	...
	register_sidebar( array(
		'name'          => __( 'Social Media', 'twentyfourteen' ),
		'id'            => 'social-media',
		'description'   => __( 'Additional sidebar that appears on the right.', 'twentyfourteen' ),
		'before_widget' => '<aside id="%1$s" class="widget %2$s">',
		'after_widget'  => '</aside>',
